...
//		Move expectedMove = new Move("+WQE2", "Q", true, new PositionCoordinate(4, 1));
	...
	private static Stream<Arguments> testStringToMoveWithChessboard() {
		return Stream.of(
				...
				//Hit
				Arguments.of("Ra2xa3", new Move("RA2xA3", "R", true, new PositionCoordinate(0,1), new PositionCoordinate(0,2), true, false, false, ""), setFigures(List.of(new Rook(new PositionCoordinate(0, 1), true, testBoard), new Rook(new PositionCoordinate(0, 2), false, testBoard)))),
				Arguments.of("Ka2xa3", new Move("KA2xA3", "K", true, new PositionCoordinate(0,1), new PositionCoordinate(0,2), true, false, false, ""), setFigures(List.of(new King(new PositionCoordinate(0, 1), true, testBoard), new Rook(new PositionCoordinate(0, 2), false, testBoard)))),
				Arguments.of("Na2xb4", new Move("NA2xB4", "N", true, new PositionCoordinate(0,1), new PositionCoordinate(1,3), true, false, false, ""), setFigures(List.of(new Knight(new PositionCoordinate(0, 1), true, testBoard), new Rook(new PositionCoordinate(1, 3), false, testBoard)))),
				Arguments.of("Qa2xa3", new Move("QA2xA3", "Q", true, new PositionCoordinate(0,1), new PositionCoordinate(0,2), true, false, false, ""), setFigures(List.of(new Queen(new PositionCoordinate(0, 1), true, testBoard), new Rook(new PositionCoordinate(0, 2), false, testBoard)))),
				Arguments.of("Pa2xb3", new Move("PA2xB3", "P", true, new PositionCoordinate(0,1), new PositionCoordinate(1,2), true, false, false, ""), setFigures(List.of(new Pawn(new PositionCoordinate(0, 1), true, testBoard), new Rook(new PositionCoordinate(1, 2), false, testBoard)))),
				Arguments.of(" a2xb3", new Move("PA2xB3", "P", true, new PositionCoordinate(0,1), new PositionCoordinate(1,2), true, false, false, ""), setFigures(List.of(new Pawn(new PositionCoordinate(0, 1), true, testBoard), new Rook(new PositionCoordinate(1, 2), false, testBoard)))),
//				Arguments.of("Pa5xb6en", new Move("PA5xB6en", "P", new PositionCoordinate(0,4), new PositionCoordinate(1,5), true, true, false, "")),
//				Arguments.of(" a5xb6en", new Move("PA5xB6en", "P", new PositionCoordinate(0,4), new PositionCoordinate(1,5), true, true, false, "")),
//				Arguments.of("Pa4xb3en", new Move("PA4xB3en", "P", new PositionCoordinate(0,3), new PositionCoordinate(1,2), true, true, false, "")),
//				Arguments.of(" a4xb3en", new Move("PA4xB3en", "P", new PositionCoordinate(0,3), new PositionCoordinate(1,2), true, true, false, "")),
